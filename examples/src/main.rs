...
async fn main() -> anyhow::Result<()> {
     ...
     let client = SoapClient::new("http://localhost:8080/weather")?
     ...
     let _xml_body = rsoap::quick_xml::se::to_string_with_root(
          "ns:GetTemperatureRequest",
          &request,
       )?;
     ...
     let response: GetTemperatureResponse =
          rsoap::envelope::deserialize_response(mock_response)?;
     println!(
         "\nMock Response:\n  Temperature: {} {}",
